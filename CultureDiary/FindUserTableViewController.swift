...
class FindUserTableViewController: UITableViewController /* , UISearchResultsUpdating */ {
    ...
    var filteredUser: [UserData] = Array()
...
//        //let item = filteredUser
//        self.filteredId = user_array.filter({ (array: String) -> Bool in
//            if user_array.contains(searchController.searchBar.text!)
//            {
//                return true
//            }
//            else
...
//        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
//        if searchController.isActive {
//            let item = filteredUser[indexPath.row]
